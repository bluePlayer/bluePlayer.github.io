window.SI.namespace('GoToUrl', window.SI.SIButton, (function (windowObject) {'use strict';
    ...
    return {
        Button: function (urlLink, linkName, btnContext, x, y, key, context, overHandler, outHandler, downHandler, upHandler,
            ...
            phaserButton =
                this.SIButton(x, y, key, context, clickHandler, overHandler, outHandler, downHandler, upHandler,
